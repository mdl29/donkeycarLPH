  ...
  <div class="car">
    <div class="header" :class="{ blur: is_paused }">
      <div
        ...
        v-if="job && (job.name === 'RECORD' || job.name === 'AI_ASSISTED')"
      >
        <div
          class="indicator"
          :class="{ record: job.name === 'RECORD', auto: job.name === 'AI_ASSISTED' }"
        ></div>
    ...
    <div class="content" :class="{ blur: is_paused }">
      <div v-if="job" class="job">
        <div v-if="race" class="race">
          ...
          >
            ...
            >
              ...
              <div class="duration">
                {{ lap.current ? formatMMs(currentlapDuration) : formatMMs(lap.duration) }}
              </div>
            </div>
          </transition-group>
        </div>
        ...
        <div v-if="!race && job && job.name != 'AI_ASSISTED'" class="no-race">
          Veuillez avancer pour lancer la course
        </div>
      </div>
      <waiting-text v-else />
      <div class="bottom" v-if="job && !is_paused">
        <div class="throttle-wrapper">
          <tachymeter :coefficient="car.throttle_scale" />
        </div>
      </div>
    </div>
  </div>
...
import tachymeter from './tachymeter.vue'
