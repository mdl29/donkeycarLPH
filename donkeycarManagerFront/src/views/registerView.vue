<template>
  <div class="main">
    ...
    <va-alert v-if="success === 'toobig'" color="danger" class="mb-4 alert" :title="'Impossible de vous enregistrer !'"> Veuillez choisir un pseudo qui contient moins de 20 caractères</va-alert>
