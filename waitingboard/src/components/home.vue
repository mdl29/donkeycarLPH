...
<div>
  <h1 class="title-header"> DONKEYCAR APP </h1>
  <vs-row class="contents-wrapper" align="center" justify="space-around" direction="column">
    <vs-col w="5" class="description-wrapper">
